...
LibraryReport.onshow=function(){
   NSB.jqxSettings["Chart2"].title = "Average time spent per student"
  NSB.jqxSettings["Chart2"].source = avgTimeData;
  NSB.jqxSettings["Chart2"].xAxis={dataField:"Date" , showGridLines:false};
